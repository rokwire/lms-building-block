...
type apiDataType interface {
	model.NudgesProcess | model.Module | model.Unit | model.SentNudge | model.ProviderCourse | model.NudgesConfig | model.UserCourse | model.Course | model.Nudge | model.Content | model.AssignmentGroup | string | model.User
}
