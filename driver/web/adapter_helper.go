...
type apiDataType interface {
	model.Module | model.NudgesConfig | model.Course | model.ProviderCourse | model.Unit | model.NudgesProcess | model.UserCourse | model.User | model.Nudge | model.SentNudge | string | model.AssignmentGroup | model.Content
}

// requestDataType represents any data type that may be sent in an API request body
type requestDataType interface {
	Def.NudgesConfig | Def.AdminReqCreateNudge | Def.AdminReqUpdateNudge | Def.AdminReqUpdateCourse | Def.AdminReqUpdateModule | Def.AdminReqUpdateUnit | apiDataType
}
