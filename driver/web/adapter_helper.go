...
type apiDataType interface {
	model.Nudge | model.SentNudge | model.Unit | string | model.Course | model.ProviderCourse | model.NudgesProcess | model.Content | model.AssignmentGroup | model.User | model.Module | model.UserCourse | model.NudgesConfig
}
