...
type apiDataType interface {
	model.UserCourse | model.Course | model.Module | model.NudgesConfig | model.SentNudge | model.AssignmentGroup | model.ProviderCourse | model.Content | model.NudgesProcess | model.Nudge | model.Unit | model.User | string
}
