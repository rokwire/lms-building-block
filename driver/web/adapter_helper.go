...
type apiDataType interface {
	model.User | model.Content | model.UserCourse | model.ProviderCourse | model.NudgesProcess | model.Course | model.NudgesConfig | model.CourseConfig | model.SentNudge | string | model.UnitWithTimezone | model.Unit | model.Module | model.Nudge | model.AssignmentGroup
}

// requestDataType represents any data type that may be sent in an API request body
type requestDataType interface {
	Def.AdminReqUpdateNudge | Def.AdminReqUpdateModule | Def.AdminReqUpdateUnit | Def.NudgesConfig | Def.AdminReqCreateNudge | Def.AdminReqUpdateCourse | apiDataType
}
