...
type apiDataType interface {
	string | model.ProviderCourse | model.Unit | model.NudgesProcess | model.Nudge | model.Module | model.Course | model.AssignmentGroup | model.NudgesConfig | model.CourseConfig | model.SentNudge | model.Content | model.UnitWithTimezone | model.User | model.UserCourse
}

// requestDataType represents any data type that may be sent in an API request body
type requestDataType interface {
	Def.NudgesConfig | Def.AdminReqUpdateCourse | Def.AdminReqUpdateUnit | Def.AdminReqUpdateModule | Def.AdminReqUpdateNudge | Def.AdminReqCreateNudge | apiDataType
}
