...
func (n streaksNotifications) setupNudgesTimer() {
...
func (n streaksNotifications) processAllNudges() {
...
func (n streaksNotifications) hasRunningProcess() (*bool, error) {
	//check count
...
func (n streaksNotifications) startProcess() (*string, error) {
	//create object
...
func (n streaksNotifications) completeProcessSuccess(processID string) error {
...
func (n streaksNotifications) completeProcessFailed(processID string, errStr string) error {
	completedAt := time.Now()
	status := "failed"
...
func (n streaksNotifications) processPhase0(processID string, nudges []model.Nudge) (*int, error) {
...
func (n streaksNotifications) addNudgeIDToUsersForGroupsBBGroup(nudgeID string, uniqueUsers map[string][]interface{}, groupsBBUsers []groups.User) error {
	for _, groupBBUser := range groupsBBUsers {
...
func (n streaksNotifications) addNudgeIDToUsersForCanvasCourse(nudgeID string, uniqueUsers map[string][]interface{},
...
func (n streaksNotifications) loadGroupsBBUsers() ([]groups.User, error) {
	groupsBBUsers := []groups.User{}
...
func (n streaksNotifications) loadCanvasCoursesUsers(nudges []model.Nudge) (map[int][]model.CoreAccount, error) {
...
func (n streaksNotifications) createBlock(processID string, curentBlock int, users []groups.User) model.Block {
...
func (n streaksNotifications) processPhase1(processID string, blocksSize int) error {
...
func (n streaksNotifications) processPhase2(processID string, blocksSize int, allNudges []model.Nudge) error {
...
func (n streaksNotifications) processPhase2Block(processID string, blockNumber int, allNudges []model.Nudge, memoryData map[int][]model.CalendarEvent) error {
	// load block data
...
func (n streaksNotifications) findUsersNudges(allNudges []model.Nudge, userAccountID string, usersNudgesMap map[string][]string) []model.Nudge {
...
func (n streaksNotifications) findNudge(allNudges []model.Nudge, nudgeID string) *model.Nudge {
...
func (n streaksNotifications) getBlockData(processID string, blockNumber int) ([]model.ProviderUser, map[string][]string, error) {
	//get data
	block, err := n.storage.FindBlock(processID, blockNumber)
	if err != nil {
...
func (n streaksNotifications) prepareUsers(users []groups.User) map[string]string {
...
func (n streaksNotifications) getGroupName() string {
...
func (n streaksNotifications) processUser(user model.ProviderUser, nudges []model.Nudge, memoryData map[int][]model.CalendarEvent) (map[int][]model.CalendarEvent, error) {
...
func (n streaksNotifications) processNudge(nudge model.Nudge, user model.ProviderUser, memoryData map[int][]model.CalendarEvent) (map[int][]model.CalendarEvent, *model.ProviderUser, error) {
...
func (n streaksNotifications) prepareNotificationData(deepLink string) map[string]string {
...
func (n streaksNotifications) processLastLoginNudgePerUser(nudge model.Nudge, user model.ProviderUser) error {
...
func (n streaksNotifications) lastLoginNeedsToSend(hours float64, now time.Time, lastLogin time.Time) bool {
...
func (n streaksNotifications) lastLoginRefreshCache(user model.ProviderUser) (*time.Time, error) {
	//cache the user data
...
func (n streaksNotifications) sendLastLoginNudgeForUser(nudge model.Nudge, user model.ProviderUser,
	...
	go func(user model.ProviderUser) {
		...
		err := n.notificationsBB.SendNotifications([]notifications.Recipient{recipient}, nudge.Name, nudge.Body, data)
		if err != nil {
...
func (n streaksNotifications) generateLastLoginHash(lastLogin time.Time, hours float64) uint32 {
...
func (n streaksNotifications) createSentNudge(nudgeID string, userID string, netID string, criteriaHash uint32, mode string) model.SentNudge {
	id, _ := uuid.NewUUID()
...
func (n streaksNotifications) processMissedAssignmentNudgePerUser(nudge model.Nudge, user model.ProviderUser) (*model.ProviderUser, error) {
...
func (n streaksNotifications) maMergeData(part1 []model.CourseAssignment, part2 []model.CourseAssignment) []model.Assignment {
...
func (n streaksNotifications) maCheckDataValidity(missedAssignments []model.CourseAssignment) ([]int, []model.CourseAssignment) {
...
func (n streaksNotifications) getMissedAssignmentsData(user model.ProviderUser, coursesIDs []int) []model.CourseAssignment {
...
func (n streaksNotifications) isAssignmentMissed(ca model.CourseAssignment) bool {
...
func (n streaksNotifications) maFillCacheIfEmpty(user model.ProviderUser) (*model.ProviderUser, error) {
...
func (n streaksNotifications) processMissedAssignment(nudge model.Nudge, user model.ProviderUser, assignment model.Assignment, hours float64) error {
...
func (n streaksNotifications) sendMissedAssignmentNudgeForUser(nudge model.Nudge, user model.ProviderUser,
	...
	go func(user model.ProviderUser) {
		...
		err := n.notificationsBB.SendNotifications([]notifications.Recipient{recipient}, nudge.Name, body, data)
		if err != nil {
...
func (n streaksNotifications) generateMissedAssignmentHash(components ...string) uint32 {
	component := strings.Join(components, "+")
	hash := utils.Hash(component)
	return hash
}

func (n streaksNotifications) findMissedAssignments(hours float64, now time.Time, assignments []model.Assignment) ([]model.Assignment, error) {
...
func (n streaksNotifications) processCompletedAssignmentEarlyNudgePerUser(nudge model.Nudge, user model.ProviderUser, lateCompletion bool) (*model.ProviderUser, error) {
...
func (n streaksNotifications) ecIsEarlyCompleted(assignment model.CourseAssignment, hours float64) bool {
...
func (n streaksNotifications) ecIsLateCompleted(assignment model.CourseAssignment) bool {
	submission := assignment.Submission
	if submission == nil {
		return false
	}
...
func (n streaksNotifications) ecFindCandidateAssignments(user model.ProviderUser) []model.CourseAssignment {
	userCourses := user.Courses
...
func (n streaksNotifications) ecLoadDataIfNecessary(user model.ProviderUser, assignments []model.CourseAssignment) (*model.ProviderUser, []model.CourseAssignment, error) {
	result := []model.CourseAssignment{}
...
func (n streaksNotifications) ecFindAssignments(user model.ProviderUser, assignmentsIDs []int) []model.CourseAssignment {
	userCourses := user.Courses
	if userCourses == nil || userCourses.Data == nil || len(userCourses.Data) == 0 {
		return []model.CourseAssignment{}
	}
...
func (n streaksNotifications) processCompletedAssignmentEarly(nudge model.Nudge, user model.ProviderUser, assignment model.Assignment, hours *float64) error {
...
func (n streaksNotifications) generateEarlyCompletedAssignmentHash(assignmentID int, submissionID int, submittedAt time.Time) uint32 {
...
func (n streaksNotifications) sendEarlyCompletedAssignmentNudgeForUser(nudge model.Nudge, user model.ProviderUser,
...
func (n streaksNotifications) processTodayCalendarEventsNudgePerUser(nudge model.Nudge, user model.ProviderUser, memoryData map[int][]model.CalendarEvent) (map[int][]model.CalendarEvent, error) {
...
func (n streaksNotifications) getCalendarEvents(user model.ProviderUser, memoryData map[int][]model.CalendarEvent) (map[int][]model.CalendarEvent, []model.CalendarEvent, error) {
...
func (n streaksNotifications) prepareTodayCalendarEventsDates() (time.Time, time.Time) {
	now := time.Now()
...
func (n streaksNotifications) processCalendarEvents(nudge model.Nudge, user model.ProviderUser, events []model.CalendarEvent) error {
...
func (n streaksNotifications) findUnsentEvents(nudge model.Nudge, user model.ProviderUser, events []model.CalendarEvent) ([]model.CalendarEvent, error) {
...
func (n streaksNotifications) isEventSent(event model.CalendarEvent, sentEvents []model.SentNudge) bool {
...
func (n streaksNotifications) sendCalendareEventNudgeForUsers(nudge model.Nudge, user model.ProviderUser,
...
func (n streaksNotifications) prepareCalendarEventNudgeBody(nudge model.Nudge, events []model.CalendarEvent) string {
...
func (n streaksNotifications) generateCalendarEventHash(eventID int) uint32 {
...
func (n streaksNotifications) processDueDateAsAdvanceReminderPerUser(nudge model.Nudge, user model.ProviderUser, numberOfDaysInAdvance int) (*model.ProviderUser, error) {
...
func (n streaksNotifications) getAssignmentsForAdvancedReminders(user model.ProviderUser, accountIDs []int, coursesIDs []int, numberOfDaysInAdvance int) []model.CourseAssignment {
	userCourses := user.Courses
	if userCourses == nil || len(userCourses.Data) == 0 {
		return []model.CourseAssignment{}
	}
...
func (n streaksNotifications) isAssignmentMatchedByDaysInAdvance(ca model.CourseAssignment, numberOfDaysInAdvance int) bool {
	assignmentData := ca.Data
	assignmentDueAt := assignmentData.DueAt
	if assignmentDueAt == nil {
		n.logger.Debugf("\t\t\tthere is no due_at for assignment %s", assignmentData.Name)
...
func (n streaksNotifications) findAssignmentsInDaysAdvance(days int, now time.Time, assignments []model.Assignment) ([]model.Assignment, error) {
...
func (n streaksNotifications) processAdvancedReminderForAssignment(nudge model.Nudge, user model.ProviderUser, assignment model.Assignment, criteriaHash uint32) error {
